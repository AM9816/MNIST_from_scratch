...
1. Download Eigen source code such that `#include "Eigen/Dense"` resolves, either paste Eigen folder into source code folder or add install directory to **C/C++ → General → Additional Include Directories**.
